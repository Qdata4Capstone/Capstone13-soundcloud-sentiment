...
\begin{itemize}
	...
	\item Matthew N. Eisler, PhD, Lecturer, Department of Engineering and Society
...
\begin{center}
  \begin{tabular}{ c | c | c }
    ...
    \hline
  \end{tabular}
  \captionof{table}{Top 6 informative features of the Bayes Classifier and the associated label ratio values}
\end{center}
...
\noindent
\textbf{Precision}: Among the negative (semi-negative or semi-positive or positive) comments detected by the system, how many are true negative comments ?

\noindent
\textbf{Recall}: For all possible negatives (semi-negative or semi-positive or really-positive) , how many were detected by system?
